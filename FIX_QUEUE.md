...
### [ ] F14 — Market calendar + session lifecycle
...
- [ ] F15 Orders `upsert` + `/trades` sync + EOD sync 15:40 IST (read `orders.service.ts`, `schema.prisma`)
