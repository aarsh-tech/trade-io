...
export const NIFTY_500_UNIVERSE = [
  ...
  'ASIANPAINT', 'ASTERDM', 'ASTRAL', 'ASTRAZEN', 'ATHERENERG', 'ATGL', 'ATUL', 'AUBANK', 'AUROPHARMA', 'AVANTIFEED', 'AWL',
  ...
  'GLAND', 'GLAXO', 'GLENMARK', 'GMDCLTD', 'GMRAIRPORT', 'GNFC', 'GODFRYPHLP', 'GODIGIT', 'GODREJAGRO', 'GODREJCP', 'GODREJIND',
  ...
  'JSWENERGY', 'JSWINFRA', 'JSWSTEEL', 'JUBLFOOD', 'JUBLINGREA', 'JUSTDIAL', 'JYOTICNC', 'JYOTHYLAB', 'KABRAEXTRU', 'KAJARIACER', 'KALPATPOWR',
  ...
  'SUBROS', 'SUDARSCHEM', 'SUMICHEM', 'SUNDARMFIN', 'SUNDRMFAST', 'SUNPHARMA', 'SUNTECK', 'SUNTV', 'SPLPETRO', 'SUPRAJIT', 'SUPREMEIND',
  ...
  'OLAELEC', 'BIKAJI', 'CPPLUS', 'JAINREC', 'PINELABS', 'EMMVEE', 'TENNIND', 'SWIGGY', 'MEESHO', 'PFOCUS', 'ATHERENERG'
];
