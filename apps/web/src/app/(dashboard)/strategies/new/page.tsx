    ...
    try {
      ...
      if (form.type === "GAMMA_BLAST_EXPIRY") {
        config = {
          ...
          maxWinsPerDay: 1,
          minPremiumNifty: Number(form.gbMinPremiumNifty || 8),
          maxPremiumNifty: Number(form.gbMaxPremiumNifty || 15),
          minPremiumSensex: Number(form.gbMinPremiumSensex || 12),
          maxPremiumSensex: Number(form.gbMaxPremiumSensex || 25),
          startTime: form.gbStartTime || "13:30",
